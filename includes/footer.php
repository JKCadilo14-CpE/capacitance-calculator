    ...
    <script src="<?php echo htmlspecialchars($assetBase ?? 'assets', ENT_QUOTES, 'UTF-8'); ?>/js/history.js" defer></script>
    <script src="<?php echo htmlspecialchars($assetBase ?? 'assets', ENT_QUOTES, 'UTF-8'); ?>/js/copy-result.js" defer></script>
    <script src="<?php echo htmlspecialchars($assetBase ?? 'assets', ENT_QUOTES, 'UTF-8'); ?>/js/theme-toggle.js" defer></script>
</body>
</html>
